        ...
        {!isLoading && !isBlocked && (
          <div className="flex-1 overflow-y-auto pt-6 md:pt-14 pb-8 flex flex-col bg-slate-50 relative animate-fade-in">
            ...
            {noticeActive && noticeText.trim() && (
              <div className="w-full bg-gradient-to-r from-[#02b396] to-[#1b6ffc] text-white py-2 px-3.5 overflow-hidden flex items-center gap-2 select-none shrink-0 sticky top-0 z-40 shadow-md">
                ...
                <div className="flex-1 overflow-hidden flex items-center h-5">
                  <Marquee
                    scrollamount="3"
                    direction="left"
                    className="text-[11px] font-extrabold font-sans whitespace-nowrap text-white"
                  >
